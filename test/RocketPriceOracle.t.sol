...
import "../src/mock/OvmL1CrossDomainMessengerMock.sol";

import "../src/RocketOvmPriceOracle.sol";
import "../src/RocketOvmPriceMessenger.sol";
...
contract RocketPriceOracleTest is Test {
    ...
    OvmL1CrossDomainMessengerMock ovmL1CrossDomainMessenger;

    RocketOvmPriceOracle priceOracle;
    RocketOvmPriceMessenger priceMessenger;
    ...
    function setUp() public {
        ...
        ovmL1CrossDomainMessenger = new OvmL1CrossDomainMessengerMock();
        ...
        priceOracle = new RocketOvmPriceOracle(address(ovmL1CrossDomainMessenger));
        // Create the messenger
        priceMessenger = new RocketOvmPriceMessenger(
